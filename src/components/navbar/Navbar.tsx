      ...
      <div className="flex justify-center w-full py-4 text-white bg-black">
        <div className="container flex items-center justify-between ms-8 text-xl font-['Roboto_Condensed']">
          <div className="flex items-center gap-8 py-4 ps-8">
            <Link
              to=""
              className="hover:underline hover:text-[#d8ff57] transition duration-300"
            >
              Inicio
            </Link>
            <Link
          ...
          <div className="relative flex items-center justify-center w-1/2 text-white">
            <form className="flex items-center justify-center w-full">
              ...
              <button
                type="submit"
                className="h-9 w-9 p-2.5 ms-2 text-sm font-medium text-black bg-[#d8ff57] hover:bg-teal-900 rounded-full border border-teal-700"
              >
