...
function CardExercicios({ exercicio }: CardExercicioProps) {
    return (
        <div className="flex flex-col rounded-2xl justify-between bg-white border-1 border-gray-950">
            <div className="px-4 ">
                <img
                    src={exercicio.midia}
                    className="mx-auto mt-1 w-full h-auto "
                    alt={exercicio.nome}
                />
                <div className="items-center">
                    <p className="text-sm text-center uppercase py-2 font-bold">
                        {exercicio.nome}
                    </p>
            ...
            <div className="flex items-end justify-around py-2 px-2 w-full rounded-b-2xl text-gray-950 bg-lime-300">
