	...
	<>
		...
		<div className="min-h-screen bg-lime-300 rounded-4xl flex flex-col items-center py-10 mt-2">
			...
			<div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-6">
				...
				<div key={index} className="bg-black shadow-lg rounded-lg p-4 flex flex-col items-center hover:scale-110">
					<img src={membro.foto} alt={membro.nome} className="w-32 h-32 rounded-full mb-4 object-cover" />
					<h2 className="text-lg font-bold text-white">{membro.nome}</h2>
					<h2 className="text-lg font-semibold text-white">Dev</h2>
					<div className="flex space-x-4 mt-2">
						<a href={membro.github} target="_blank" rel="noopener noreferrer" className="bg-yellow-400 p-2 rounded-full hover:scale-110">
							<GithubLogo size={26} weight="bold" className="text-black" />
						</a>
						<a href={membro.linkedin} target="_blank" rel="noopener noreferrer" className="bg-yellow-400 p-2 rounded-full hover:scale-110">
